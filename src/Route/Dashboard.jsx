            ...
            <div className='flex min-h-screen'>
                ...
                <div className={`bg-[#60B5FF]  p-5 w-64 space-y-4 transition-all duration-300 ${isOpen ? 'block' : 'hidden'} md:block`}>
                    <ul className='space-y-2'>
                        ...
                        <li><NavLink to='/dashboard/newCompany' className='flex items-center gap-2 p-2 rounded-lg hover:bg-[#EFDCAB] text-gray-900 hover:text-black transition duration-300'><IoMdAddCircle /> Post New Company</NavLink></li>
                        ...
                        <li><NavLink to='/dashboard/profile' className='flex items-center gap-2 p-2 rounded-lg hover:bg-[#EFDCAB] text-gray-900 hover:text-black transition duration-300'><FaUserCircle className='text-xl' /> Profile</NavLink></li>
