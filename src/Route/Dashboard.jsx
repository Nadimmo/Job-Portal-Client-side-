            ...
            <div className='flex min-h-screen'>
                ...
                <div className={`bg-[#EFDCAB]  p-5 w-64 space-y-4 transition-all duration-300 ${isOpen ? 'block' : 'hidden'} md:block`}>
                    <ul className='space-y-2'>
                        ...
                        <li><NavLink to='/dashboard/addJob' className='flex items-center gap-2 p-2 rounded-lg hover:bg-[#FFB22C] text-gray-900 hover:text-black transition duration-300'><IoMdAddCircle /> Add Job</NavLink></li>
