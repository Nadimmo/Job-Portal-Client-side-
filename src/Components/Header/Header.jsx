...
const Header = () => {
    const Links = (
        <>
            ...
            <li><NavLink to={'/jobs'} className="nav-link">All Jobs</NavLink></li>
            <li><NavLink to={'/companies'} className="nav-link">All Companies</NavLink></li>
    ...
    return (
        <div className="navbar bg-gray-800 text-white shadow-lg fixed z-10 w-full">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-2xl font-bold">Wellfound</a>
            </div>
