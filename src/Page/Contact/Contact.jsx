...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const userInfo = { name, message, email }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
          ...
          >
            ...
            <div className="text-center">
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-xl text-lg font-bold hover:scale-105 transform transition-all duration-300 cursor-pointer"
              >
                Send Message
              </button>
            </div>
